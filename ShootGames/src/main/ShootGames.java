...
import Commands.ShootGamesCE_mw;
import Config.GrenadesLoader;
import Config.GunsLoader;
import Config.SpawnPoints;
import Listener.WeaponListener;
...
public class ShootGames extends JavaPlugin
{
  ...
  public ShootGamesCE_mw mwCE = new ShootGamesCE_mw(this);
